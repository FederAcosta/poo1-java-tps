...
public class Sistema {
 ...
 // Traer Jugador por DNI
	...
	public int calcularGolesTotalesJugador(Jugador jugador) {
	    int total = 0;
	    for (Torneo t : torneos) {
	        total += t.calcularGolesJugador(jugador);
	    }
	    return total;
	}
	public int calcularAsistenciasTotalesJugador(Jugador jugador) {
	    int total = 0;
	    for (Torneo torneo : torneos) {
	        total += torneo.calcularAsistenciasJugador(jugador);
	    }
	    return total;
	}
