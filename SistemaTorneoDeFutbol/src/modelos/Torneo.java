...
public class Torneo {
	...
	public int calcularGolesJugador(Jugador jugador) {
	    ...
	    for (EstadisticaJugador est : jugador.getEstadisticas()) {
	        // Contamos solo si el partido de esa estadística pertenece a este torneo
	        if (partidos.contains(est.getPartido())) {
	...
	public List<String> generarTablaGoleadores() {
	    ...
	    for (Equipo e : equipos) {
	        for (Jugador j : e.getJugadores()) {
	            ...
	            if (goles > 0) { // solo mostramos si hizo goles
	...
	public List<String> generarTablaAsistidores() {
	    ...
	    for (Equipo e : equipos) {
	        for (Jugador j : e.getJugadores()) {
	            ...
	            if (asistencias > 0) { // solo mostramos si dio asistencias
