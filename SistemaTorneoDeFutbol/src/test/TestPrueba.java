...
public class TestPrueba {
    ...
    public static void main(String[] args) {
        ...
        // Segundo partido (vuelta)
        EstadisticaJugador est3 = new EstadisticaJugador(mbappe, partido2, 2, 0, 90); // Mbappé mete 2 goles
        EstadisticaJugador est4 = new EstadisticaJugador(messi, partido2, 2, 0, 90);  // Messi mete 2 goles

        messi.agregarEstadistica(est1);
        mbappe.agregarEstadistica(est2);
        
        

        // Crear torneo y agregar partido
        Torneo champions = new Torneo("Champions League", "Primavera",
                new ArrayList<>(),      // lista de equipos
                new ArrayList<>(),      // lista de partidos
                LocalDate.of(2023, 3, 1),
        ...
        sistema.agregarTorneo(champions);

        System.out.println("\n Goles totales (todos los torneos):");
        System.out.println("Messi: " + sistema.calcularGolesTotalesJugador(messi));
        System.out.println("Mbappé: " + sistema.calcularGolesTotalesJugador(mbappe));

        System.out.println("\n Asistencias totales (todos los torneos):");
        System.out.println("Messi: " + sistema.calcularAsistenciasTotalesJugador(messi));
        System.out.println("Mbappé: " + sistema.calcularAsistenciasTotalesJugador(mbappe));
    }
}
